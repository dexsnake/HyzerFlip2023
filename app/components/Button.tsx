...
export function Button(props: ButtonProps) {
	...
	return (
		<Pressable
			className="rounded border bg-flip-100 border-flip-100 flex-row items-center justify-center px-3 py-3 overflow-hidden min-h-[50px]"
			style={$viewStyle}
		...
		>
			{(state) => (
				<>
					...
					<Text
						className="text-white text-base font-medium tracking-wider text-center flex-shrink flex-grow-0 z-[2]"
						tx={tx}
						text={text}
						txOptions={txOptions}
...
const $pressedViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
	default: { backgroundColor: tw.flip[200] },
